          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <button
                ...
                onClick={() => {
                  setLoading(true);
                  window.location.href = "/api/auth/google?redirect=/restaurante/register";
                }}
                disabled={loading}
                className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-white px-5 py-3 text-sm font-semibold text-text shadow-sm hover:bg-gray-50 hover:-translate-y-0.5 transition-all disabled:opacity-50"
              >
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs"><span className="bg-surface px-3 text-text-muted">o completá el formulario</span></div>
              </div>
